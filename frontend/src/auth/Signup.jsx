          ...
          <div className="w-full max-w-[340px] flex flex-col h-full">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 flex-1">
              ...
              <div className="space-y-1.5 mb-3">
                ...
                <div className="flex bg-[#f0f4ff] rounded-lg p-1 relative h-9 items-center">
                  {/* Dynamic highlighting pill */}
                  <div 
                    className={`absolute top-1 bottom-1 w-[calc(50%-4px)] bg-white rounded-md shadow-sm transition-transform duration-300 ease-in-out ${selectedRole === "seller" ? "translate-x-full" : "translate-x-0"}`} 
                  />
                  ...
                  {[
                    ...
                    <label
                      key={value}
                      className={`flex-1 flex items-center justify-center cursor-pointer relative z-10 transition-colors ${
                        selectedRole === value ? "text-[#004ac6] font-bold" : "text-[#5c6880] font-medium hover:text-[#141b2d]"
                      } text-[11px] h-full ${disabled ? "opacity-50 cursor-not-allowed" : ""}`}
                    >
                      <input
                        type="radio"
                        value={value}
