      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
           <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-[0.65rem] font-bold uppercase tracking-widest text-[#0f49d7]">Legal Framework</span>
           </div>
           ...
           <p className="text-[#0f49d7] text-[0.62rem] mt-3 font-bold uppercase tracking-widest bg-[#0f49d7]/5 inline-block px-3 py-1 rounded-full border border-[#0f49d7]/10">
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="bg-[#f8f9fc] border border-[#eef2ff] p-4 rounded-xl">
                  <span className="font-bold text-[#0f49d7] block text-[0.65rem] mb-1 uppercase tracking-widest">{item.t}</span>
                  <span className="text-[0.74rem] font-bold text-[#11182d] opacity-70 uppercase tracking-tight leading-snug">{item.d}</span>
                </div>
              ))}
            </div>
          </section>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                {[ "Regulatory Violation", "IP Infringement", "Fraudulent Listing", "Malicious Scripts" ].map((t, i) => (
                   <div key={i} className="bg-[#f8f9fc] border border-[#eef2ff] p-3 rounded-xl flex flex-col items-center text-center gap-2">
                      ...
                      <span className="text-[0.62rem] font-bold text-[#11182d] uppercase tracking-widest leading-tight">{t}</span>
                   </div>
                ))}
            </div>
          </section>
          ...
          <section className="bg-white border border-[#eef2ff] rounded-[24px] p-6 shadow-sm">
             <h2 className="text-[0.9rem] font-bold text-[#11182d] uppercase tracking-widest mb-4">
              Legal Liaison
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 bg-[#f8f9fc] border border-[#eef2ff] p-5 rounded-2xl">
               <div>
                  <p className="text-[0.55rem] font-bold text-[#0f49d7] uppercase tracking-widest mb-1 opacity-60">Correspondence</p>
                  <p className="text-[0.7rem] font-bold text-[#11182d] uppercase tracking-widest">wondercarthelp@gmail.com</p>
               </div>
               <div>
                  <p className="text-[0.55rem] font-bold text-[#0f49d7] uppercase tracking-widest mb-1 opacity-60">Hotline</p>
                  <p className="text-[0.7rem] font-bold text-[#11182d] uppercase tracking-widest">+91 7226987466</p>
               </div>
               <div>
                  <p className="text-[0.55rem] font-bold text-[#0f49d7] uppercase tracking-widest mb-1 opacity-60">Jurisdiction</p>
                  <p className="text-[0.7rem] font-bold text-[#11182d] uppercase tracking-widest">Surat, Gujarat, India</p>
               </div>
            </div>
          </section>
        </div>
        ...
        <div className="mt-8 border-t border-[#eef2ff] pt-8 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
           <p className="text-[0.62rem] font-bold text-[#5d6a84] uppercase tracking-widest max-w-[280px] leading-relaxed">
           ...
           <div className="flex gap-6">
              {[ "Home", "Privacy", "Contact" ].map((link, i) => (
                <Link 
                  ...
                  className="text-[0.65rem] font-bold text-[#11182d] uppercase tracking-widest border-b-2 border-transparent hover:border-[#0f49d7] transition-all"
                >
                  {link}
                </Link>
              ))}
