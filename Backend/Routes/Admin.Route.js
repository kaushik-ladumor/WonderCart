...
adminRouter.put("/products/:productId/approve", Authorization, authorizationRole('admin'), adminController.productApproval);
adminRouter.delete("/products/:productId/reject", Authorization, authorizationRole('admin'), adminController.rejectProduct);
